...
$get_webcams = $mysqli->query("
  ...
  WHERE evolve_webcams.promoted = 1
");         
...
<div class="x_panel">
  <div class="x_title">
    <h4 class="pull-left" ><?php lang_string('webcams_promoted_title')?></h4>
            ...
            foreach($chunk as $relmedia) {
              ...
              <div class="col-md-6 col-xs-6 rel_projects">
                <div class="inner_item_rel">
                  <a href="<?php echo $relmedia['seo_id']; ?>" class="lazyload_parent" title="<?php echo $media['content']?>" >
