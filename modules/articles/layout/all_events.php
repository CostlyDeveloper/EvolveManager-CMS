<?php
  $feat_same_cat_art = $mysqli->query("
  ...
  WHERE evolve_articles.category = '8'
    AND evolve_articles.published = '1'
  ORDER BY evolve_articles.date DESC
  
  LIMIT 5
  ");
  if ($feat_same_cat_art->num_rows > 0) { 
  ?>
<div class="col-md-12 col-sm-12 margin-bottom-40">
  <h4><?php lang('all_events')?></h4>
  <div class="row">
    <?php
      while($news = $feat_same_cat_art->fetch_assoc()){
