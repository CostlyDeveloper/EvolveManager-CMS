var Layout = function () {
    ...
    return {
        ...
        initOWL: function () {
              ...
              $('.owl-featured_projects').owlCarousel({
            loop:true,
            dots: true,
            margin:10,
            nav:true, 
        ...
        $('.owl-article_gallery').owlCarousel({
            items:1,
            merge:false,
            loop:true,
            margin:10,
         ...
         $('.owl-featured_video').owlCarousel({
            items:1,
            merge:false,
            loop:true,
            margin:10,
           ...
           $('.owl-recent_articles').owlCarousel({
              loop:true,
              dots: true,
              margin:0,
              nav:false, 
          ...
          $('.owl-hosted_by_home').owlCarousel({
              loop:true,
              dots: true,
              margin:10,
              nav:false, 
          ...
          $('.owl-recommendation_home').owlCarousel({
              loop:true,
              dots: true,
              margin:10,
              nav:false, 
