            ...
            <?php if($data['facebook'] || $data['dribbble'] || $data['linkedin'] || $data['twitter'] || $data['skype'] || $data['github'] || $data['youtube'] || $data['dropbox'] || $data['googleplus']){ ?>
                ...
                <div class="col-md-4 col-sm-4 text-center">
                    <ul class="social social-circle">
                        <?php if($data['facebook']){ ?> <li><a href="<?php echo $data['facebook']?>"><i class="icon-facebook"></i></a></li><?php } ?>
                        <?php if($data['dribbble']){ ?> <li><a href="<?php echo $data['dribbble']?>"><i class="icon-dribbble"></i></a></li><?php } ?>
                        <?php if($data['linkedin']){ ?> <li><a href="<?php echo $data['linkedin']?>"><i class="icon-linkedin"></i></a></li><?php } ?>
                        <?php if($data['twitter']){ ?> <li><a href="<?php echo $data['twitter']?>"><i class="icon-twitter"></i></a></li><?php } ?>
                        <?php if($data['skype']){ ?> <li><a href="skype:<?php echo $data['skype']?>?userinfo"><i class="icon-skype"></i></a></li><?php } ?>
                        <?php if($data['github']){ ?> <li><a href="<?php echo $data['github']?>"><i class="icon-github"></i></a></li><?php } ?>
                        <?php if($data['youtube']){ ?> <li><a href="<?php echo $data['youtube']?>"><i class="icon-youtube"></i></a></li><?php } ?>
                        <?php if($data['dropbox']){ ?> <li><a href="<?php echo $data['dropbox']?>"><i class="icon-dropbox"></i></a></li><?php } ?>
                        <?php if($data['googleplus']){ ?> <li><a href="<?php echo $data['googleplus']?>"><i class="icon-google-plus"></i></a></li><?php } ?>
                    </ul>
                </div>
                <!-- END SOCIAL -->
