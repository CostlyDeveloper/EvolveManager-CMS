...
$get_product_category_list = $mysqli->query("
    SELECT evolve_product_category_data.title, evolve_product_category.id as instance_id
                            ...
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <?php while ($category_item = $get_product_category_list->fetch_assoc()) { ?>
                                    <tr id="instanceID_<?php echo $category_item['instance_id']; ?>" class="even pointer">
                                        ...
                                        <td><?php echo get_items_nr($category_item['instance_id'], 'evolve_products') ?> </td>
                                        <td class="text-right last">

                                            <a href="index.php?product_list=<?php echo $category_item['instance_id']; ?>"
                                               class="btn btn-primary btn-xs"><i
                                                        class="fa fa-list"></i> <?php echo $lang['button_show_items']; ?>
                                            </a>

                                            <a href="index.php?product_category=<?php echo $category_item['instance_id']; ?>"
