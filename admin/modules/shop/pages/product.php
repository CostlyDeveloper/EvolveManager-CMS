...
$get_instance = $mysqli->query("
    SELECT evolve_products.*, evolve_products_data.*, evolve_product_category_data.*, evolve_products_data.title as product_title, evolve_product_category_data.title as category_title
    FROM evolve_products
      
    LEFT JOIN evolve_product_category_data
    ON evolve_product_category_data.for_instance = evolve_products.category
      AND evolve_product_category_data.lang =  '$default_language'
      
    LEFT JOIN evolve_products_data
            ...
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="x_panel">
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                ...
                                <div id="myTabContent" class="tab-content">
			                        ...
			                        foreach ($slugs_arr
				                        ...
				                        $get_instance = $mysqli->query("
                        SELECT evolve_products.*, evolve_products_data.*,evolve_products_data.seo_id as product_seoid, evolve_product_category_data.seo_id as catseo
                        FROM evolve_products
                        ...
                        LEFT JOIN evolve_products_data
                        ON evolve_products_data.for_instance = evolve_products.id
                          AND evolve_products_data.lang = '$slug'
