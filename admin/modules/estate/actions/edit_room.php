...
if (isset($_POST['instanceID'])) {
    ...
    foreach ($slugs_arr as $slug) {
        ...
        $unique = $mysqli->query("
          ...
          ON evolve_estate_rooms_data (for_instance,lang)");
        //if(!$unique) print_r($mysqli->error);
        $sql = $mysqli->query("  
          INSERT INTO evolve_estate_rooms_data (for_instance, lang, seo_id, title, tagline, description, content, keywords) 
        ...
        $unique = $mysqli->query("
              ALTER TABLE evolve_estate_rooms_data
