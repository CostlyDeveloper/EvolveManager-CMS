...
$get_instance = $mysqli->query("
    SELECT evolve_estate_rooms.*, evolve_estate_rooms_data.*, evolve_estate_data.*, evolve_estate_rooms_data.title, evolve_estate_data.title as category_title
    FROM evolve_estate_rooms
      
    LEFT JOIN evolve_estate_data
    ON evolve_estate_data.for_instance = evolve_estate_rooms.category
      AND evolve_estate_data.lang =  '$default_language'
      
    LEFT JOIN evolve_estate_rooms_data
    ON evolve_estate_rooms_data.for_instance = evolve_estate_rooms.id
      AND evolve_estate_rooms_data.lang =  '$default_language'  
    WHERE evolve_estate_rooms.id = '$instance_id'
  ");
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><?php echo $lang[$category_name . '_room_editing']; ?></h2>
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                ...
                                <div id="myTabContent" class="tab-content">
			                        ...
			                        foreach ($slugs_arr
				                        ...
				                        $get_instance = $mysqli->query("
                        SELECT evolve_estate_rooms.*, evolve_estate_rooms_data.*,evolve_estate_rooms_data.seo_id as product_seoid, evolve_estate_data.seo_id as catseo
                        FROM evolve_estate_rooms
                        
                        LEFT JOIN evolve_estate_data
                        ON evolve_estate_data.for_instance = evolve_estate_rooms.category
                        AND evolve_estate_data.lang = '$slug'
                        
                        LEFT JOIN evolve_estate_rooms_data
                        ON evolve_estate_rooms_data.for_instance = evolve_estate_rooms.id
                          AND evolve_estate_rooms_data.lang = '$slug'
                        ...
                        ");
                                        ...
                                        <div role="tabpanel" class="tab-pane fade <?php echo $i == 0 ? 'active' : ''; ?> in" id="tab_content<?php echo $slug; ?>" aria-labelledby="tab_con<?php echo $slug; ?>">
                                            ...
                                            <div class="form-group">
                                                <label><?php echo $lang[$category_name . '_title']; ?></label>
                                                <input name="title_<?php echo $slug; ?>" class="form-control" value="<?php echo $cat_item['title']; ?>" type="text" autocomplete="off" />
                                            </div>
                                            <div class="form-group">
                                                <label><?php echo $lang[$category_name . '_tagline']; ?></label>
                                                <input name="tagline_<?php echo $slug; ?>" class="form-control" value="<?php echo $cat_item['tagline']; ?>" type="text" autocomplete="off" />
                                            </div>

                                            <div class="form-group">
                                                <label><?php echo $lang[$category_name . '_seoid']; ?>
                                                    <a data-toggle="tooltip" data-placement="top" title="<?php echo $lang[$category_name . '_seo_tt']; ?>"><i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                          ...
                          <?php } ?>
                                            ...
                                            <div class="form-group">
                                                <label><?php echo $lang[$category_name . '_description']; ?></label>
                                            ...
                                            <div class="form-group">
                                                <label><?php echo $lang[$category_name . '_tags']; ?> </label>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" id="featured" name="featured" <?php echo checked($item['featured']); ?>
                                           class="flat" /> <?php echo $lang[$category_name . '_featured']; ?>
                                </label>
                            </div>
                            <div class="checkbox">
                                <label> <input type="checkbox" name="promoted" <?php echo checked($item['promoted']); ?>
                                               class="flat" /> <?php echo $lang[$category_name . '_promoted']; ?>
                                </label>
                            </div>
                            <button type="submit" class="btn btn-success pull-right"><?php echo $lang['button_submit']; ?></button>
                        </div>
                    ...
                    <!--<div class="x_panel">
                        <div class="x_title">
                            <h2><?php /*echo $lang[$category_name . '_colors']; */?></h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li class="singletb"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                </li>
                            </ul>
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    <button type="button" class="btn btn-info btn-xs add_field"><?php /*echo $lang[$category_name . '_add_multi_color']; */?></button>
                                </div>
                                <div class="col-md-8 col-sm-8 col-xs-8 text-right <?php /*echo ($item['colors_data_json']) ? '':'none'*/?>" id="activate_colors">
                                    <label> <?php /*echo $lang[$category_name . '_activate_colors']; */?>
                                    </label>
                                            ...
                                            <li class="added_color">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-6 row form-group">
                                                        <div class="input-group">
                                                            <input name="multiColorName[]" class="form-control" placeholder="<?php /*echo $lang[$category_name . '_color_name'] */?>" value="<?php /*echo $color->colorName */?>" type="text" autocomplete="off" />
                                                        </div>
                                                    </div>
