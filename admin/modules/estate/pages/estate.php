<?php
  ...
  $get_category = $mysqli->query("
    SELECT evolve_estate_list.*, evolve_estate_data.*, evolve_estate_list.id as wcat_id
  ...
  $get_layout = $mysqli->query("
    SELECT evolve_estate_type.id, evolve_estate_type.name
    FROM evolve_estate_type
    ORDER BY id
  ");
                  ...
                  <?php $slugs_arr = languages();
                    ...
                    foreach($slugs_arr as $slug){
                      ...
                      $get_wcat = $mysqli->query("
                        SELECT evolve_estate_data.seo_id, evolve_estate_data.description, evolve_estate_data.title, evolve_estate_list.id as wcat_id
                        FROM evolve_estate_list
