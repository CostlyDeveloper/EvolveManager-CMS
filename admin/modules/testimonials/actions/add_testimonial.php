<?php
  ...
  //CREATE NEW 
  $sql = $mysqli->query("  
    INSERT INTO evolve_testimonials (name, for_instance, author) 
...
<li class="list-group-item" data-id="<?php echo $new_id;?>" id="instanceID_<?php echo $new_id; ?>">
  ...
  <div class="col-xs-4 col-md-2 pull-right text-right">
    <a href="index.php?testimonial=<?php echo $new_id; ?>" class="btn_in_item btn-info btn-xs"><i class="fa fa-pencil"></i> <?php echo $lang['button_edit']; ?> </a>
